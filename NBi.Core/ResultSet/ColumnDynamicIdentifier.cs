...
{
    class ColumnDynamicIdentifier : ColumnPositionIdentifier, IEquatable<ColumnDynamicIdentifier>
    {
        ...
        public bool Next()
        {
            Position = InternalNext(Position);
            return true;
        }
        

        public override bool Equals(object obj) => this.Equals(obj as ColumnDynamicIdentifier);
        public override int GetHashCode() => Name.GetHashCode() ^35 * Position.GetHashCode() ^17;
