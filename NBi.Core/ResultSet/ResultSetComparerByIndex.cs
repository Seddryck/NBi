...
{
    public class ResultSetComparerByIndex : IResultSetComparer
    {
        ...
        public ResultSetComparerByIndex()
        {
        }

        public ResultSetComparerByIndex(ResultSetComparisonByIndexSettings settings)
        {
        ...
        protected ResultSetCompareResult doCompare(DataTable x, DataTable y)
        {
            ...
            WriteSettingsToDataTableProperties(y, indexBasedSettings);
            WriteSettingsToDataTableProperties(x, indexBasedSettings);

            CheckSettingsAndDataTable(y, indexBasedSettings);
            CheckSettingsAndDataTable(x, indexBasedSettings);

            CheckSettingsAndFirstRow(y, indexBasedSettings);
            CheckSettingsAndFirstRow(x, indexBasedSettings);

            var keyComparer = new DataRowKeysComparer(indexBasedSettings, x.Columns.Count);
        ...
        {
            if (indexBasedSettings.KeysDef != ResultSetComparisonByIndexSettings.KeysChoice.All)
            {
        ...
        {
            indexBasedSettings = new ResultSetComparisonByIndexSettings(
                columnsCount,
