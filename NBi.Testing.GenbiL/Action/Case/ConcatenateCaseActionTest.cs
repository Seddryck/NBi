...
namespace NBi.Testing.GenbiL.Action.Case
{
    public class ConcatenateCaseActionTest
    {
        ...
        public void Execute_SecondColumn_ValueConcatenated()
        {
            ...
            Assert.That(state.TestCaseCollection.CurrentScope.Content.Rows[0]["secondColumn"], Is.EqualTo("secondCell1alpha"));
            Assert.That(state.TestCaseCollection.CurrentScope.Content.Rows[1]["secondColumn"], Is.EqualTo("alpha"));
        ...
        public void Execute_SecondColumn_ColumnsConcatenated()
        {
            ...
            Assert.That(state.TestCaseCollection.CurrentScope.Content.Rows[0]["secondColumn"], Is.EqualTo("secondCell1thirdCell1firstCell1"));
            Assert.That(state.TestCaseCollection.CurrentScope.Content.Rows[1]["secondColumn"], Is.EqualTo("thirdCell2firstCell2"));
            Assert.That(state.TestCaseCollection.CurrentScope.Content.Rows[2]["secondColumn"], Is.EqualTo("(none)"));
        }
        ...
        {
            var state = BuildInitialState();
            state.TestCaseCollection.CurrentScope.Content.Rows[0]["firstColumn"] = "(none)";
            ...
            Assert.That(state.TestCaseCollection.CurrentScope.Content.Rows[0]["secondColumn"], Is.EqualTo("(none)"));
        }
    }
}
