...
namespace NBi.Testing.Unit.Core.ResultSet.Comparison
{
    ...
    public class IndexComparerTest
    {
        ...
        public void Compare_SameRows_ReturnEqual()
        {
            ...
            var comparer = new IndexComparer(AnalyzersFactory.EqualTo(), BuildSettingsKeyValue());
        ...
        {
            //Buiding object used during test
            var comparer = new IndexComparer(AnalyzersFactory.EqualTo(), BuildSettingsKeyValue(ColumnType.Numeric));
        ...
        {
            //Buiding object used during test
            var comparer = new IndexComparer(AnalyzersFactory.EqualTo(), BuildSettingsKeyValue(ColumnType.DateTime));
        ...
        {
            //Buiding object used during test
            var comparer = new IndexComparer(AnalyzersFactory.EqualTo(), BuildSettingsKeyValue(ColumnType.Boolean));
        ...
        public void Compare_DuplicatedRowInRef_ThrowException()
        {
            ...
            var ex = Assert.Throws<ComparerException>(delegate { comparer.Compare(reference, actual); });
        ...
        {
            //Buiding object used during test
            var comparer = new IndexComparer(AnalyzersFactory.EqualTo(), BuildSettingsKeyValue(1));
            var reference = BuildDataTable(new string[] { "Key0", "Key1" }, new double[] { 0, 1 });
        ...
        {
            //Buiding object used during test
            var comparer = new IndexComparer(AnalyzersFactory.EqualTo(), BuildSettingsKeyValueIgnore(0));
        ...
        public void Compare_SameKeysSameValuesUselessColumnsNoneValuesMatching_ReturnEqual()
        {
            ...
            //Buiding object used during test
            var comparer = new IndexComparer(AnalyzersFactory.EqualTo(), settings);
            var reference = BuildDataTable(new string[] { "Key0", "Key1" }, new double[] { 0, 1 }, new string[] { "Useless0", "Useless1" });
            var actual = BuildDataTable(new string[] { "Key0", "Key1" }, new double[] { 0, 1 }, new string[] { "0Useless0", "0Useless1" });
