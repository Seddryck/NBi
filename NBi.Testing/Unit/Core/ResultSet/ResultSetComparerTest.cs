...
namespace NBi.Testing.Unit.Core.ResultSet
{
    ...
    public class ResultSetComparerTest
    {
        ...
        {
            //Buiding object used during test
            var comparer = new ResultSetComparer(BuildSettingsKeyValue(ColumnType.Numeric));
        ...
        {
            //Buiding object used during test
            var comparer = new ResultSetComparer(BuildSettingsKeyValue(ColumnType.DateTime));
        ...
        {
            //Buiding object used during test
            var comparer = new ResultSetComparer(BuildSettingsKeyValue(ColumnType.Boolean));
        ...
        {
            //Buiding object used during test
            var comparer = new ResultSetComparer(BuildSettingsKeyValue(1));
            var reference = BuildDataTable(new string[] { "Key0", "Key1" }, new double[] { 0, 1 });
        ...
        {
            //Buiding object used during test
            var comparer = new ResultSetComparer(BuildSettingsKeyValueIgnore(0));
