...
namespace NBi.Testing.Unit.Core.Sequence.Resolver.Loop
{
    ...
    public class SentinelDateTimeLoopStrategyTest
    {
        ...
        {
            var strategy = new SentinelDateTimeLoopStrategy(new DateTime(2018, 1, 1), new DateTime(2018, 1, 5), new FixedDuration(new TimeSpan(stepDay, 0, 0, 0)));
        ...
        {
            var strategy = new SentinelDateTimeLoopStrategy(new DateTime(2018, 1, 1), new DateTime(2018, 5, 10), new MonthDuration(stepMonth));
        ...
        {
            var strategy = new SentinelDateTimeLoopStrategy(new DateTime(2018, 1, 1), new DateTime(2019, 4, 10), new YearDuration(stepMonth));
            var final = DateTime.MinValue;
            while (strategy.IsOngoing())
                final = strategy.GetNext();
        ...
        {
            var strategy = new SentinelDateTimeLoopStrategy(new DateTime(2018, 1, 1), new DateTime(2018, 1, 2), new FixedDuration(new TimeSpan(1, 0, 0, 0)));
        ...
        {
            var strategy = new SentinelDateTimeLoopStrategy(new DateTime(2018, 1, 3), new DateTime(2018, 1, 2), new FixedDuration(new TimeSpan(1, 0, 0, 0)));
        ...
        {
            var strategy = new SentinelDateTimeLoopStrategy(new DateTime(2018, 1, 1), new DateTime(2018, 1, 1), new FixedDuration(new TimeSpan(1, 0, 0, 0)));
        ...
        {
            var strategy = new SentinelDateTimeLoopStrategy(new DateTime(2018, 1, 1), new DateTime(2018, 1, 10), new FixedDuration(new TimeSpan(1, 0, 0, 0)));
            Assert.That(strategy.IsOngoing(), Is.True);
        }
    }
}
