...
namespace NBi.Testing.Unit.NUnit.Structure
{
    ...
    public class ContainsConstraintTest
    {
        ...
        [Test]
        public void WriteTo_FailingAssertionForSubsetHierarchy_TextContainsFewKeyInfo()
        {
        ...
        [Test]
        public void WriteTo_FailingAssertionForExactHierarchy_TextContainsFewKeyInfo()
        {
            var exp = new string[] { "Expected level 1", "Expected level 2" };
            var request = new DiscoveryRequestFactory().Build(
                        "connectionString",
            ...
            var containsConstraint = new ContainsConstraint(exp) { CommandFactory = factory };
            containsConstraint = containsConstraint.Exactly;
