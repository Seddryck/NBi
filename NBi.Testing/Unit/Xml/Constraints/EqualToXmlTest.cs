...
namespace NBi.Testing.Unit.Xml.Constraints
{
    ...
    public class EqualToXmlTest
    {
        ...
        public void DeserializeEqualToKey_QueryFile2_List()
        {
            ...
            Assert.That(ts.Tests[testNr].Constraints[0], Is.TypeOf<EqualToXml>());
            Assert.That(((EqualToXml)ts.Tests[testNr].Constraints[0]).KeysDef, Is.EqualTo(ResultSetComparisonByIndexSettings.KeysChoice.First));
        }
        ...
        public void DeserializeEqualToQuery_QueryFile5_List()
        {
            ...
            Assert.That(((EqualToXml)ts.Tests[testNr].Constraints[0]).ValuesDef, Is.EqualTo(ResultSetComparisonByIndexSettings.ValuesChoice.Last));
