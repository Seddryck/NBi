...
namespace NBi.UI.Genbi.View.TestSuiteGenerator
{
    partial class TestSuiteView : Form
    {
        ...
        public TestSuiteView()
        {
            ...
            TestCasesPresenter = new TestCasesPresenter(new RenameVariableWindow(), new FilterWindow(), new ConnectionStringWindow(), new TestCaseManager(), State.TestCases, State.Variables, State.ConnectionStringNames);
